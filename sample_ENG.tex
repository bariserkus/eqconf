...
\date{%%% \date kullanılarak, kurum ve e-posta bilgileri girilmektedir.
	\affils{1}{Res. Assist., Civil Eng. Dept., Abece University, Istanbul}\\
	\affils{*}{Prof. Dr., Civil Eng. Dept., Abece University, Istanbul}\\
	\email{correspondingauthor@kurum.edu.tr}%%% Sadece gönderen yazarın e-postası girilecektir.
}
